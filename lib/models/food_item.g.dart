...
int _foodItemEstimateSize(
  ...
  bytesCount += 3 + object.expiryStatus.length * 3;
  {
...
void _foodItemSerialize(
  ...
  writer.writeString(offsets[4], object.expiryStatus);
  writer.writeString(offsets[5], object.imagePath);
  writer.writeBool(offsets[6], object.isExpired);
  writer.writeBool(offsets[7], object.isExpiredOrExpiringSoon);
  writer.writeBool(offsets[8], object.isExpiringSoon);
...
extension FoodItemQuerySortBy on QueryBuilder<FoodItem, FoodItem, QSortBy> {
  ...
  QueryBuilder<FoodItem, FoodItem, QAfterSortBy> sortByDaysUntilExpiry() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'daysUntilExpiry', Sort.asc);
    });
  }

  QueryBuilder<FoodItem, FoodItem, QAfterSortBy> sortByDaysUntilExpiryDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'daysUntilExpiry', Sort.desc);
    });
  }

  QueryBuilder<FoodItem, FoodItem, QAfterSortBy> sortByDescription() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'description', Sort.asc);
    });
  }

  QueryBuilder<FoodItem, FoodItem, QAfterSortBy> sortByDescriptionDesc() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<FoodItem, FoodItem, QAfterSortBy> sortByExpiryStatus() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'expiryStatus', Sort.asc);
    });
  }

  QueryBuilder<FoodItem, FoodItem, QAfterSortBy> sortByExpiryStatusDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'expiryStatus', Sort.desc);
    });
  }

  QueryBuilder<FoodItem, FoodItem, QAfterSortBy> sortByImagePath() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'imagePath', Sort.asc);
    });
  }

  QueryBuilder<FoodItem, FoodItem, QAfterSortBy> sortByImagePathDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'imagePath', Sort.desc);
    });
  }

  QueryBuilder<FoodItem, FoodItem, QAfterSortBy> sortByIsExpired() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isExpired', Sort.asc);
    });
  }

  QueryBuilder<FoodItem, FoodItem, QAfterSortBy> sortByIsExpiredDesc() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<FoodItem, FoodItem, QAfterSortBy> sortByIsExpiringSoon() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isExpiringSoon', Sort.asc);
    });
  }

  QueryBuilder<FoodItem, FoodItem, QAfterSortBy> sortByIsExpiringSoonDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension FoodItemQuerySortThenBy
  ...
  QueryBuilder<FoodItem, FoodItem, QAfterSortBy> thenByDaysUntilExpiry() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'daysUntilExpiry', Sort.asc);
    });
  }

  QueryBuilder<FoodItem, FoodItem, QAfterSortBy> thenByDaysUntilExpiryDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'daysUntilExpiry', Sort.desc);
    });
  }

  QueryBuilder<FoodItem, FoodItem, QAfterSortBy> thenByDescription() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'description', Sort.asc);
    });
  }

  QueryBuilder<FoodItem, FoodItem, QAfterSortBy> thenByDescriptionDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'description', Sort.desc);
    });
  }
  ...
  QueryBuilder<FoodItem, FoodItem, QAfterSortBy> thenByExpiryStatus() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'expiryStatus', Sort.asc);
    });
  }

  QueryBuilder<FoodItem, FoodItem, QAfterSortBy> thenByExpiryStatusDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'expiryStatus', Sort.desc);
    });
  }
  ...
  QueryBuilder<FoodItem, FoodItem, QAfterSortBy> thenByImagePath() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'imagePath', Sort.asc);
    });
  }

  QueryBuilder<FoodItem, FoodItem, QAfterSortBy> thenByImagePathDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'imagePath', Sort.desc);
    });
  }

  QueryBuilder<FoodItem, FoodItem, QAfterSortBy> thenByIsExpired() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isExpired', Sort.asc);
    });
  }

  QueryBuilder<FoodItem, FoodItem, QAfterSortBy> thenByIsExpiredDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isExpired', Sort.desc);
    });
  }
  ...
  QueryBuilder<FoodItem, FoodItem, QAfterSortBy> thenByIsExpiringSoon() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isExpiringSoon', Sort.asc);
    });
  }

  QueryBuilder<FoodItem, FoodItem, QAfterSortBy> thenByIsExpiringSoonDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isExpiringSoon', Sort.desc);
    });
  }
...
extension FoodItemQueryWhereDistinct
  ...
  QueryBuilder<FoodItem, FoodItem, QDistinct> distinctByDaysUntilExpiry() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<FoodItem, FoodItem, QDistinct> distinctByIsExpired() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<FoodItem, FoodItem, QDistinct> distinctByIsExpiringSoon() {
    return QueryBuilder.apply(this, (query) {
...
extension FoodItemQueryProperty
  ...
  QueryBuilder<FoodItem, int, QQueryOperations> daysUntilExpiryProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'daysUntilExpiry');
    });
  }

  QueryBuilder<FoodItem, String?, QQueryOperations> descriptionProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<FoodItem, String, QQueryOperations> expiryStatusProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'expiryStatus');
    });
  }

  QueryBuilder<FoodItem, String?, QQueryOperations> imagePathProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'imagePath');
    });
  }

  QueryBuilder<FoodItem, bool, QQueryOperations> isExpiredProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<FoodItem, bool, QQueryOperations> isExpiringSoonProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<FoodItem, int, QQueryOperations> quantityProperty() {
    return QueryBuilder.apply(this, (query) {
